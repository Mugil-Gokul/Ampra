...
import { FaBook, FaThLarge, FaCertificate, FaUsers } from "react-icons/fa";
...
const stats = [
  { icon: <FaBook />, number: "7", label: "Test Providers" },
  { icon: <FaThLarge />, number: "200", label: "Total Courses" },
  { icon: <FaCertificate />, number: "700", label: "General Certificates" },
  { icon: <FaUsers />, number: "1600", label: "Happy Students" },
];
...
const AboutOurValues = () => {
  return (
    <div className="w-full">
      ...
      {/* GRAPHIC COUNT SECTION */}
      <section className="bg-[#800000] py-12 m-10 rounded-2xl">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-6 text-white">
